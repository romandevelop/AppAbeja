...
public class Abeja {
    ...
    public static List<Abeja> familiaList(){
        ...
        list.add(new Abeja(R.string.colletidae_name, R.string.colletidae_descripcion,R.drawable.colletidae));
        list.add(new Abeja(R.string.halictidae_name, R.string.halictidae_descripcion,R.drawable.halictidae));
        list.add(new Abeja(R.string.megachilidae_name, R.string.megachilidae_descripcion,R.drawable.megachilidae));
        list.add(new Abeja(R.string.apidae_name, R.string.apidae_descripcion,R.drawable.apidae));
        return list;
    }
